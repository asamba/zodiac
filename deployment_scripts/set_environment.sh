...
export SIRMIONE_ALIAS=AS7531sirmione
export LIMONE_ALIAS=AS7531limone
export SCORPIO_ALIAS=AS7531scorpio
export VIRGO_ALIAS=AS7531virgo
export LIBRA_ALIAS=AS7531libra
export ZODIAC_ALIAS=AS7531zodiac
...
export ZODIAC_INSTANCE=samba0_happy_wanderer
